...
> eUSCI_B0/B1 roles and shows buses the MSP doesn't have. See [msp-ex/SUPERSEDED.md](./msp-ex/SUPERSEDED.md).
>
> **Canonical pin map (generated — do not hand-maintain):** source of truth is
> [crates/bsp/connections.toml](./crates/bsp/connections.toml); human views are generated by
> `just bsp docs` → **[generated/PINMAP.md](./crates/bsp/generated/PINMAP.md)** (every pin) and
> **[generated/BUS-ROLES.md](./crates/bsp/generated/BUS-ROLES.md)** (the I2C bus roles). In short:
> **SENSOR = eUSCI_B0 (P1.2/P1.3), STEM = eUSCI_B1 (P3.2/P3.6); MSP is on Stem + Sensor only (no SYS_I2C).**
